  ...
  sections: [
...

    {
      ...
      body: [
        ...
        { type: "callout", variant: "tip", text: "**Serve by stage, not by version.** Your inference service loads `models:/fraud-detector/Production`. Rolling back a bad deploy is then a one-line registry transition — no redeploy, no code change. The registry is the single source of truth for 'what is live right now.'" },
...

    {
      ...
      body: [
        ...
        { type: "table",
          ...
          rows: [
            ["**Quantization**", "store/compute weights in int8 (or fp16) instead of fp32", "~4× smaller, ~2–4× faster, tiny accuracy hit"],
