  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { type: "p", text: "With $n\\_embd=384$, $6$ heads, $6$ layers and block size $256$, this is roughly a **10-million-parameter** model — about 1/16,500th of GPT-3's 175 B, running the identical computation. Count them with `sum(p.numel() for p in model.parameters())`." },
      ]
    },
    {
      id: "training",
