  ...
  sections: [
...

    {
      ...
      body: [
        ...
        { type: "math", tex: String.raw`z_{\text{white}} = \Lambda_k^{-1/2} W_k^\top \tilde{x} = \Sigma_k^{-1} U_k^\top \tilde{x}\,\sqrt{m-1}` },
...

    {
      ...
      body: [
        ...
        { type: "p", text: "'Match' means minimize the **Kullback–Leibler divergence** between the high-D neighbor distribution $P$ and the low-D one $Q$, by gradient descent on the 2D coordinates $y_i$:" },
