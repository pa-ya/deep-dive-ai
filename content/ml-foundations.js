  ...
  sections: [
...

    {
      ...
      body: [
        ...
        { type: "p", text: "**Wolpert & Macready (1997)** proved something humbling: **averaged over *all possible* problems, every learning algorithm has identical performance.** No algorithm is universally best; a model that excels on one class of problems must pay for it by being worse on another." },
